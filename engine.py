...
def run_alignment_engine(blocks, full_target_text):
    ...
    for i, block in enumerate(blocks):
        ...
        pt_window = full_target_text[window_start : window_end]
        ...
        if not matched_text:
            ...
            # Fallback: Just use an empty string so we don't crash, 
            # or you could implement a logic to 'skip' this block.
            matched_text = ""
        else:
            ...
            if found_index == -1 and len(matched_text) > 20:
                ...
                if pt_window.count(anchor) == 1:
                    found_index = pt_window.find(anchor)
