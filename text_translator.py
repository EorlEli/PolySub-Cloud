...
def verify_translation_quality(source_chunks, translated_chunks, target_language="Portuguese"):
    ...
    11. **Proper Nouns & Tech Names**: Do NOT "correct" or alter seemingly unknown but valid proper nouns, recent technologies, product names, or newly released LLM models into older, more common entities. Trust the source text.
